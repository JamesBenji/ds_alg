...
or may not be filled with rock. It takes one minute to move one unit north, south, east, west, up or down.
...
L, R and C (all limited to 30 in size). L is the number of levels making up the dungeon.
...
Your starting position is indicated by 's' and the exit by the letter 'E'. There's a single blank line after each level.
